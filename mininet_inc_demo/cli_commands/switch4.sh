...
table_add MyIngress.tb_add_sdn_int_from_ipv4    MyIngress.ac_sdn_int_push   10.45.0.2/32        => 200
...
#               Table Name                 Action Name                    SDN Label  Register Index
table_add MyIngress.tb_handle_inc  MyIngress.ac_sdn_inc_update_register      201   =>     